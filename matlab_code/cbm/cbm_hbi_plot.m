...
for i=1:np
    ...
    if strcmp(direction,'vertical')
        ...
        bar(ax,xm{i},bw,'FaceColor',colbar,'EdgeColor','k','linewidth',1);
    ...
    if strcmp(direction,'horizontal')
        ...
        h = axes('Position',pos1);    
        barh(ax,xm{i},bw,'FaceColor',colbar,'EdgeColor','k','linewidth',1);
        set(gca,'yticklabel',model_names);
        hax = ancestor(h, 'axes');
        hxaxes = get(hax,'YAxis');
        set(hxaxes,'Fontsize',fsx);        

        xlabel(ylabels{i},'fontsize',fsy);
        set(gca,'xlim',[0 1.05]);
